...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        footer_settings.title = RichText(
            'SecureDrop is a project of <a href="https://freedom.press">Freedom of the Press Foundation</a>.'
        )
        ...
        if fm_created:
            ...
            MenuItem.objects.bulk_create(
                [
                    ...
                    MenuItem(
                        text="Get Support", link_url="#", menu=footer_menu, sort_order=3
                    ),
                    MenuItem(
                        text="Media",
                        link_url="#",
