    ...
    def handle(self, *args, **options):
        ...
        ResultState.objects.bulk_create([
            ...
            ResultState(
                ...
                failure_text=RichText('The page is not <a class="scan-result__link" href="https://hstspreload.org/">HSTS preloaded</a>'),
                is_warning=True,
                result_group=https,
            ),
            ResultState(
            ...
            ResultState(
                ...
                success_text='HSTS preloaded',
                failure_text=RichText('<a class="scan-result__link" href="https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP">Content Security Policy (CSP)</a> loads only from the origin domain.'),
            ...
            ResultState(
                ...
                success_text=RichText('Ensures that the server forbids embedding this page within an iframe, to <a class="scan-result__link" href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-Frame-Options">prevent clickjacking attacks</a>. Otherwise another site could embed the Landing Page and mess with it.'),
                failure_text=RichText('The server does not forbid embedding this page within an iframe, to <a class="scan-result__link" href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-Frame-Options">prevent clickjacking attacks</a>. Another site could embed the Landing Page and mess with it.'),
            ...
            ResultState(
                ...
                success_text=RichText('<a class="scan-result__link" href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Cache-Control">Cache-Control</a> headers set properly.'),
                failure_text=RichText('<a class="scan-result__link" href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Cache-Control">Cache-Control</a> headers not set properly.'),
                is_warning=True,
                fix_text=RichText('<p>Add the following to your security headers:</p><pre>Cache-Control "max-age=0, no-cache, no-store, must-revalidate, private"</pre>'),
                result_group=caching,
            ),
            ...
            ResultState(
                name='expires_set',
                success_text=RichText('The page is <a class="scan-result__link" href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Expires">marked as expired</a>, so no cache will be used.'),
                failure_text=RichText('The page is not <a class="scan-result__link" href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Expires">marked as expired</a>. Cache may be used.'),
                is_warning=True,
