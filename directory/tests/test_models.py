...
class SecuredropTest(TestCase):
    ...
    def setUpTestData(cls):
        cls.directory_page = DirectoryPageFactory()

    def test_securedrop_can_save_expected_urls(self):
        securedrop = SecureDropInstance(
        ...
        securedrop.save()
        self.assertIn(securedrop, SecureDropInstance.objects.all())

    def test_securedrop_cannot_save_empty_urls(self):
        securedrop = SecureDropInstanceFactory(landing_page='')
...
class ResultTest(TestCase):
    def setUp(self):
        self.securedrop = SecureDropInstanceFactory(
            organization='Freedom of the Press Foundation',
            landing_page='freedom.press',
            onion_address='notreal.onion'
        )
