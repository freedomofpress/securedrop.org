...
class DirectoryPage(RoutablePageMixin, MetadataPageMixin, Page):
    ...
    source_warning = RichTextField(
        blank=True,
        null=True,
        help_text="A warning for sources about checking onion addresses.",
    )
    submit_title = models.CharField(
        max_length=255, default="Want to get your instance listed?"
    )
    ...
    org_details_form_title = models.CharField(
        max_length=100, default="Enter organization details"
    )
    ...
    content_panels = Page.content_panels + [
        ...
        MultiFieldPanel(
            ...
            children=[
                ...
                PageChooserPanel(
                    "directory_submission_form", page_type="forms.FormPage"
                ),
    ...
    settings_panels = Page.settings_panels + [
        ...
        MultiFieldPanel(
            (FieldPanel("org_details_form_title"), FieldPanel("org_details_form_text")),
    ...
    def get_instances(self, filters=None):
        ...
        """
        instances = (
            DirectoryEntry.objects.child_of(self).live().listed().order_by("title")
        )
        if filters:
